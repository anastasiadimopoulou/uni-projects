package com.example.unitestapplication.view.SubjectUpdate;
...
import com.example.unitestapplication.view.Subject.UpdateSubject.SubjectUpdatePresenter;
...
public class SubjectUpdatePresenterTest {
    ...
    public void setUp() {
        ...
        subjectDAO.save(new Subject("Math", 1, 1,5));
        subjectDAO.save(new Subject("Physics", 2, 1,4));
        subjectDAO.save(new Subject("Chemistry", 3, 2,4));
    }
    @After
    ...
    public void testSetView() {
        SubjectUpdateView mockView = new SubjectUpdateView() {
